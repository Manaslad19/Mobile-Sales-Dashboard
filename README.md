...
Dax : created measures and calculated column using formulas like sum, average, countrows, Calculate, TotalMTD, same period last year, IF . All these measures used in visuals as well as for calculations 

Power BI : Used power bi to convert numbers in awesome visual like Map chart, pie chart, clustered bar chart, line chart, kpi, filters, tables, buttons, added images. All this help to identify customer trend, top product, month to date report, last year report in an easy to understand visual way.
